...
init() {
    setdvar("enable_mannequins", "0"); // enable mannequin counter 
    ...
    setdvar("start_weap", "tazer_knuckles_zm", "0"); // start weapon, put 0 to disable custom start weapon tazer_knuckles_zm is default
}
